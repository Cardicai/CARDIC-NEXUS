...
const TELEGRAM_CHANNEL = 'https://t.me/cardicnexusglobal';
...
export default function NavBar() {
  ...
  const onWebLinkClick = (e: ReactMouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
  ...
  return (
    <header className='cnx-nav'>
      ...
      <button
        ref={hubButtonRef}
        type='button'
        className={`floatingHub ${hubOpen ? 'active' : ''}`}
        aria-haspopup='true'
      ...
      >
        <div className='navHubHeader'>
          <div>
            ...
            <h2 className='navHubTitle'>Navigate the Ecosystem</h2>
          </div>
          <button
            type='button'
      ...
      <style jsx>{`
        ...
        .floatingHub.active {
          ...
          color: #081018;
          box-shadow: 0 0 40px rgba(16, 165, 255, 0.45);
        }
