          ...
          <div className='cnx-method-panel'>
            ...
            {activeMethod === 'paypal' && (
              <div className='cnx-method-info'>
                ...
                <ul>
                  <li>
                    Request an invoice or send directly to
                    payments@cardicnex.us.
                  </li>
                  <li>
                    Use the “Friends & Family” option only if you know the desk.
                  </li>
                  <li>Reference your TradingView username in the memo.</li>
                </ul>
                <a
                  className='cnx-method-link'
                  href='mailto:payments@cardicnex.us?subject=PayPal%20Invoice%20Request'
                >
            ...
            {activeMethod === 'bank' && (
              <div className='cnx-method-info'>
                ...
                <ul>
                  <li>
                    NGN, GBP, EUR, and AED rails available with same-day
                    confirmation.
                  </li>
                  <li>
                    Submit your preferred currency to receive the nearest
                    banking partner.
                  </li>
                  <li>
                    All transfers reconciled by the Nexus finance desk within 2
                    business hours.
                  </li>
                </ul>
                <a
                  ...
                  rel='noreferrer'
                >
                  DM @REALCARDIC for bank details ↗
                </a>
              </div>
            )}
            ...
            {activeMethod === 'apple-pay' && (
              <div className='cnx-method-info'>
                ...
                <ul>
                  <li>
                    Tap-to-pay invoice delivered to your Apple device within
                    minutes.
                  </li>
                  <li>
                    Supports Apple Card, Visa, Mastercard, and Amex wallets.
                  </li>
                  <li>
                    Share your iCloud email so the desk can route the payment
                    request.
                  </li>
                </ul>
                <a
