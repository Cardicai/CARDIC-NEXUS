...
const ruleSections = [
  ...
  },
  {
    ...
    body: `Official updates, leaderboard links, and account details arrive via email. Join the Cardic Nexus Telegram group for live updates and contact support@cardicnex.us or @REALCARDIC on Telegram for assistance.`,
  },
  {
