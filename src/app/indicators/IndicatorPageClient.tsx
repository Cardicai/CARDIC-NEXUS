...
export default function IndicatorPageClient({
  ...
  const openCheckout = (planId: string, planLabel: string) => {
    setCheckoutPlan({ id: planId, label: planLabel });
  ...
  return (
    <div className='relative min-h-screen overflow-hidden bg-[#06040f] text-slate-100'>
            ...
            >
              ...
              <button
                ...
                onClick={() =>
                  openCheckout(
                    indicator.id,
                    `${indicator.title} — ${indicator.price}`
                  )
                }
            ...
            >
              ...
              <div className='flex flex-col gap-2 text-sm'>
                <button
                  type='button'
                  onClick={() =>
                    openCheckout(pkg.id, `${pkg.name} — ${pkg.price}`)
                  }
      ...
      <TrialFormModal open={trialOpen} onOpenChange={setTrialOpen} />
      <CheckoutModal
