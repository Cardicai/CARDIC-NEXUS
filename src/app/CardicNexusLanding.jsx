...
const nexusEdgeHighlights = [
  ...
  },
  {
    ...
    description:
      'Prop firm rulebooks codified into risk templates so every bot deployment stays audit-ready.',
    accent: 'from-sky-400/40 via-sky-500/20 to-transparent',
  },
  {
    title: 'Capital Amplified',
    description:
      'Performance council monitors trader equity curves and allocates instant funding when metrics confirm edge.',
...
export default function CardicNexusLanding() {
  ...
  return (
    <div className='relative overflow-hidden bg-[#03040c] text-slate-200'>
      ...
      <section className='relative mx-auto max-w-6xl px-6 pb-24 md:pb-28'>
        <div className='space-y-10 overflow-hidden rounded-[44px] border border-white/10 bg-black/60 p-10 shadow-[0_40px_120px_rgba(2,6,23,0.6)] backdrop-blur'>
          <div className='flex flex-col gap-6 md:flex-row md:items-center md:justify-between'>
            <div className='space-y-3 text-center md:text-left'>
              <p className='text-xs uppercase tracking-[0.32em] text-slate-200'>
                Nexus Precision Suite
              </p>
              <h2 className='text-3xl font-semibold text-white md:text-4xl'>
                Operational Sharpness You Can Feel
              </h2>
              <p className='text-sm leading-relaxed text-slate-300 md:max-w-2xl md:text-base'>
                Beyond visuals, the Cardic Nexus desk doubles down on
                reliability. Every feed, bot, and onboarding flow is engineered
                to stay stable under pressure while elevating the glow of the
                experience.
              </p>
            </div>
            <div className='rounded-3xl border border-emerald-400/20 bg-emerald-500/10 px-5 py-4 text-center shadow-[0_20px_60px_rgba(16,185,129,0.2)] md:text-left'>
              <p className='text-[10px] uppercase tracking-[0.32em] text-emerald-100'>
                Live Ops Signal
              </p>
              <p className='mt-2 text-lg font-semibold text-white'>
                Desk is Online & Monitoring 17 Feeds
              </p>
              <p className='text-xs text-emerald-100/80'>
                Automation heartbeat refreshed every 60 seconds.
              </p>
            </div>
          </div>
