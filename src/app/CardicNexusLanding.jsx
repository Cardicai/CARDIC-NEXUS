  ...
  return (
    <div className='cnx-root'>
      ...
      <section id='heat' className='cnx-section'>
        <h2>Cardic Heat 🔥</h2>
        <div className='cnx-offer-banner'>
          <span className='cnx-offer-pill'>Limited Drop</span>
          <span className='cnx-offer-text'>
            50% OFF FOR ALL CARDIC HEAT INDICATORS
          </span>
        </div>
      ...
      <style>{`
        ...
        *{box-sizing:border-box} html,body,#root{height:100%}
        ...
        .cnx-offer-banner{
          ...
          background:linear-gradient(120deg, rgba(21,12,38,.9), rgba(12,9,28,.92));
          box-shadow:0 22px 48px rgba(8,5,20,.55);
        }
        .cnx-offer-pill{
          font-size:11px;
          letter-spacing:.32em;
        ...
        @media (max-width: 520px){
          ...
          .cnx-offer-banner{padding:12px 16px}
          .cnx-offer-text{font-size:13px; letter-spacing:.12em}
