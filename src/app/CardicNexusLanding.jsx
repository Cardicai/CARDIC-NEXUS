...
export default function CardicNexusLanding() {
  ...
  return (
    <div className='cnx-root'>
          ...
          {projects.map((p) => (
            <article key={p.title} className='cnx-card'>
              ...
              <div className='cnx-card-actions'>
                <a className='cnx-btn cnx-btn-ghost' href='#crypto'>
                  Buy
                </a>
        ...
        <div className='cnx-grid' style={{ marginTop: 10 }}>
          ...
          <article className='cnx-card'>
            ...
            <div className='cnx-card-actions' style={{ marginTop: 12 }}>
              <a className='cnx-btn cnx-btn-blue' href='#crypto'>
                Get 2.0
              </a>
            </div>
          </article>
      ...
      {/* CRYPTO PAYMENT */}
      <section id='crypto' className='cnx-section cnx-crypto'>
        <h2>Crypto Payments</h2>
        <p className='cnx-text'>
          Pick any crypto address of your choice and provide your TradingView
          username and proof of payment to my email.
        </p>
        <div className='cnx-grid'>
          <article className='cnx-card cnx-crypto-card'>
            <Image
              src='https://cryptologos.cc/logos/tether-usdt-logo.png?v=025'
              alt='USDT'
              width={40}
              height={40}
              className='cnx-crypto-logo'
            />
            <h3>USDT</h3>
            <p className='cnx-crypto-address'>
      ...
      <style>{`
        ...
        *{box-sizing:border-box} html,body,#root{height:100%}
        ...
        /* Crypto */
        .cnx-crypto{background:#fff; color:#000; border-radius:24px;}
        .cnx-crypto .cnx-text{color:#000}
        .cnx-crypto-card{background:#000; color:#fff; border:1px solid #fff}
        .cnx-crypto-logo{display:block; margin:0 auto 8px; width:40px; height:40px}
        .cnx-crypto-address{word-break:break-all; font-family:monospace; font-size:14px}
