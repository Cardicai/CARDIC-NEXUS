...
export default function CardicNexusLanding() {
  ...
  return (
    <div className='relative overflow-hidden bg-[#03040c] text-slate-200'>
      ...
      <section className='relative mx-auto flex min-h-screen max-w-6xl flex-col gap-10 px-6 pb-20 pt-[max(env(safe-area-inset-top),1rem)] md:gap-12 md:pt-6 lg:pt-8'>
