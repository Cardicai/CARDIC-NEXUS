...
export default function CardicNexusLanding() {
  ...
  return (
    <div className='relative overflow-hidden bg-[#03040c] text-slate-200'>
      ...
      <div className='brandRibbon'>
        <div className='brandRibbonInner'>
          <BrandLogo size='lg' className='brandRibbonLogo' />
          <div className='brandRibbonText'>
            <span className='brandRibbonLabel'>Cardic Nexus Global</span>
            <span className='brandRibbonStatement'>
              Trading • Funding • Intelligence
            </span>
          </div>
        </div>
      </div>

      <section className='relative mx-auto flex max-w-6xl flex-col gap-12 px-6 pb-20 pt-20 md:pt-28'>
        <div className='space-y-10 text-center'>
          ...
          <div className='heroHeading'>
            <span className='heroOverline'>Cardic Nexus</span>
            <h1 className='heroTitle'>
              <span className='heroTitlePrimary'>Global Command Suite</span>
        ...
        <div className='mx-auto grid w-full max-w-5xl gap-5 md:grid-cols-2 xl:grid-cols-4'>
          <div className='heroBroadcast rounded-3xl border border-white/10 bg-black/40 p-6 text-center shadow-[0_24px_80px_rgba(14,23,42,0.45)] backdrop-blur md:col-span-2 xl:col-span-2'>
          ...
          <div className='marketBoard rounded-3xl border border-sky-500/20 bg-sky-500/10 p-5 shadow-[0_30px_90px_rgba(14,23,42,0.45)] backdrop-blur md:col-span-2 xl:col-span-2'>
          ...
          <div className='feedbackCard rounded-3xl border border-white/10 bg-white/5 p-5 shadow-[0_30px_90px_rgba(14,23,42,0.45)] backdrop-blur md:col-span-2 xl:col-span-2'>
          ...
          {activeBulletin ? (
            <div className='alphaPulseCard relative overflow-hidden rounded-3xl border border-fuchsia-500/30 bg-gradient-to-br from-fuchsia-500/10 via-black/40 to-sky-500/10 p-6 shadow-[0_34px_100px_rgba(88,28,135,0.45)] backdrop-blur md:col-span-2 xl:col-span-2'>
      ...
      <style jsx>{`
        ...
        .brandRibbonInner {
          ...
          background: rgba(12, 13, 24, 0.78);
          box-shadow: 0 24px 80px rgba(8, 12, 24, 0.45);
        ...
        .brandRibbonLabel {
          ...
          color: rgba(245, 199, 107, 0.85);
        }
        .brandRibbonStatement {
          font-size: 15px;
          color: #e2e8f0;
