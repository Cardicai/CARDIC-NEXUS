        ...
        <section className='grid gap-6 md:grid-cols-2 xl:grid-cols-4'>
          ...
          <article className='rounded-3xl border border-purple-400/50 bg-purple-500/10 p-6 shadow-lg shadow-purple-900/40 backdrop-blur'>
            ...
            <p className='mt-3 text-sm text-purple-100/80'>
              Keep trading with discipline to stay in the competition.
            </p>
          </article>
          <article className='rounded-3xl border border-cyan-400/50 bg-cyan-500/10 p-6 shadow-lg shadow-cyan-900/40 backdrop-blur'>
            <h2 className='text-sm font-semibold uppercase tracking-wide text-cyan-200'>
              Countdown
            </h2>
            <div className='mt-4 flex items-center gap-3 text-4xl font-black text-cyan-100'>
              <span>{countdown.days}</span>
              <span className='text-xl font-semibold text-cyan-200/80'>d</span>
              <span>{countdown.hours}</span>
              <span className='text-xl font-semibold text-cyan-200/80'>h</span>
              <span>{countdown.minutes}</span>
              <span className='text-xl font-semibold text-cyan-200/80'>m</span>
              <span>{countdown.seconds}</span>
              <span className='text-xl font-semibold text-cyan-200/80'>s</span>
            </div>
            <p className='mt-3 text-sm text-cyan-100/80'>
              Next elimination hits once the timer expires.
            </p>
          </article>
        </section>

        <section className='grid gap-6 lg:grid-cols-[2fr,1fr]'>
          <article className='rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-blue-950/50 backdrop-blur'>
            <div className='flex flex-wrap items-center justify-between gap-4'>
              <h2 className='text-2xl font-semibold text-white'>
                Leaderboard Preview
              </h2>
              <p className='text-sm text-cyan-100/80'>Updated hourly</p>
            </div>
            <div className='mt-6 overflow-hidden rounded-2xl border border-white/10'>
              <table className='min-w-full divide-y divide-white/10 text-left text-sm text-slate-100/90'>
                <thead className='bg-white/5 text-xs uppercase tracking-wider text-slate-200/80'>
                  <tr>
            ...
            <p className='mt-4 text-sm text-slate-200/80'>
              Full leaderboard access unlocks after registration approval.
            </p>
          </article>

          <aside className='grid gap-6'>
            <article className='rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-blue-950/40 backdrop-blur'>
              ...
              <Link
                href='/#rules'
                className='mt-6 inline-flex items-center justify-center rounded-full border border-cyan-400/60 bg-cyan-500/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-cyan-100 transition hover:bg-cyan-400/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-200'
              >
                View Full Rulebook
              </Link>
            </article>

            <article className='rounded-3xl border border-amber-400/30 bg-amber-500/10 p-6 shadow-xl shadow-amber-900/40 backdrop-blur'>
              <h2 className='text-xl font-semibold text-white'>Support</h2>
              <p className='mt-3 text-sm text-amber-100/80'>
                Need help with your account or submissions? Reach us any time.
              </p>
              <div className='mt-4 space-y-2 text-sm text-amber-100'>
                ...
                <p>
                  <span className='font-semibold'>Telegram:</span> @cardicnexus
                </p>
              </div>
            </article>
          </aside>
