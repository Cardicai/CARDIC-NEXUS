    ...
    <div className='partner-page'>
      <section className='hero'>
        <div className='hero-inner'>
          ...
          <h1>
            Mint your referral link. Apply as a Nexus Partner (NP). Earn 35% for
            life.
          </h1>
          <p className='subcopy'>
          ...
          <div className='hero-actions'>
            ...
            <a href='#np' className='cta secondary'>
              Submit Nexus Partner (NP) application
            </a>
          </div>
        </div>
      </section>
      ...
      <section className='cards-grid'>
        ...
        <article id='np' className='card ib-card'>
          <header>
            <h2>Introducer – Nexus Partner (NP) Application</h2>
            <p>
