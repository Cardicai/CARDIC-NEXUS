...
const botPrograms = [
  ...
  {
    name: 'Nexus Flux Arbitrage Radar',
    focus:
        ...
        <section className='grid gap-6 md:grid-cols-3'>
          {botPrograms.map((program) => (
            ...
            >
              ...
              <span className='mt-auto inline-flex w-fit items-center justify-center rounded-full border border-amber-300/60 bg-amber-200/10 px-4 py-1 text-[11px] font-semibold uppercase tracking-[0.32em] text-amber-100'>
                Coming Soon
              </span>
            </div>
          ))}
