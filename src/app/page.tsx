    ...
    <div className='relative min-h-[100svh] bg-gradient-to-b from-black to-[#020617] text-white antialiased'>
      ...
      <Section className='bg-transparent' delay={0.15}>
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          className='inline-flex items-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-6 py-3 text-lg font-semibold
                     shadow-lg backdrop-blur-md hover:bg-white/15'
        >
          Join The Revolution
